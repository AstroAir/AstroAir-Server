...
JSON = -ljsoncpp
ASILIB = -Iair-asi/ -L../libasi/armv7 -I../libasi -lASICamera2

all: libasi wsserver astroair-server
#构建主服务器
astroair-server:libasi wsserver main.cpp
	@echo $(GREEN)"Building C++ WebSocket Server ... \033[0m"
	@$(CC) $(OUT) astroair-server main.o asi_ccd.o wsserver.o logger.o $(WEBSOCKETPP) $(JSON) $(ASILIB)
