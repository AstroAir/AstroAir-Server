...
if(HAS_NOVA)
	...
	add_library(NOVA src/libastro.cpp)
	target_link_libraries(airserver PUBLIC NOVA)
	add_library(ANOVA src/telescope/air_nova.cpp)
	target_link_libraries(airserver PUBLIC ANOVA)
