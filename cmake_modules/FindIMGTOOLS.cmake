...
if(HAS_FITSIO)
	...
	add_library(FITSIO src/tools/ImgFitsIO.cpp)
	target_link_libraries(airserver PUBLIC FITSIO)
...
if(HAS_OPENCV AND HAS_BASE64)
	...
	add_library(OPENCV src/tools/ImgTools.cpp)
	target_link_libraries(airserver PUBLIC OPENCV)
