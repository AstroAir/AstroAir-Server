...
option(OpenGL3 "Using OpenGl3" OFF)
if(IMGUI)
    find_path(IMGUI_GL glfw3.h /usr/include/GLFW)
    find_path(IMGUI_GL glfw3.h /usr/local/include/GLFW)
    find_library(IMGUI_GL_LIB libglfw.so /usr/lib/x86_64-linux-gnu)
    find_library(IMGUI_GL_LIB libglfw.so /usr/local/lib/x86_64-linux-gnu)
    ...
    if(OpenGL3)
        add_library(IMGUI src/gui/imgui.cpp src/gui/imgui_draw.cpp src/gui/imgui_tables.cpp src/gui/imgui_widgets.cpp src/gui/imgui_impl_glfw.cpp src/gui/imgui_impl_opengl3.cpp src/gui/gl3w.c)
    ...
    target_link_libraries(airserver PUBLIC libdl.so)
endif()