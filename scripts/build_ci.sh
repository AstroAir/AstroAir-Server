...
sudo apt install make cmake indi-full phd2 clang-11 libwebsocketpp-dev libasio-dev libopencv-dev libcfitsio-dev libccfits-dev libssl-dev libnova-dev libgphoto2-dev libboost-dev libusb-1.0-0-dev libgsl-dev libcurl4-gnutls-dev libyaml-cpp-dev -y
